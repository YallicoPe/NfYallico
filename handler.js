...
this.reply(m.chat, `🇦🇱 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙔𝘼𝙇𝙇𝙄𝘾𝙊𝙄𝙉𝙎`, m)
continue     
}
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝙽𝙵 𝙱𝙾𝚃 💓'].getRandom(), thumbnail: gataImg.getRandom(), sourceUrl: [md, nna, nn, nnn, yt, ig, paypal, fb].getRandom() }}}}, tg)
